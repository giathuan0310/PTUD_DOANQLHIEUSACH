...
public class GUI_QLHD extends JFrame {
	private static final long serialVersionUID = 1L;
	private JPanel contentPane;
	private JTable table;
	private JTable table_1;
	private JTextField textField;
	private JTextField tftkhdtnt;
	...
	public GUI_QLHD() {
		...
		btnThoat.setIcon(new ImageIcon(GUI_QLHD.class.getResource("/imgs/exit_img.png")));
		...
		JScrollPane jtbQLHD = new JScrollPane();
		jtbQLHD.setBounds(0, 142, 1136, 108);
		contentPane.add(jtbQLHD);
		
		table = new JTable();
		table.setFont(new Font("Tahoma",Font.PLAIN, 18));
		jtbQLHD.setViewportView(table);
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Mã HĐ", "Mã NV", "Mã KH", "Mẫ quầy", "Ngày lập", "VAT", "Ưu đãi", "Tổng tiền"
			}
		));
		...
		JScrollPane JtbCTHD = new JScrollPane();
		JtbCTHD.setBounds(77, 317, 984, 108);
		contentPane.add(JtbCTHD);
		...
		JtbCTHD.setViewportView(table_1);
		btnKhachHang.setBounds(0, 59, 165, 58);
		contentPane.add(btnKhachHang);
		...
		btnTaohd.setBounds(10, 493, 202, 38);
		contentPane.add(btnTaohd);
		
		
		JButton btnXhd = new JButton("Xuất hóa đơn");
...
//		contentPane.add(comboBox);
		...
		cbttmn.setModel(new DefaultComboBoxModel(new String[] {"Tìm theo", "Mã ", "Ngày"}));
		cbttmn.setBounds(777, 493, 142, 41);
		contentPane.add(cbttmn);
		
		tfttmn = new JTextField();
		tfttmn.setFont(new Font("Tahoma", Font.PLAIN, 18));
		tfttmn.setBounds(919, 493, 142, 41);
		contentPane.add(tfttmn);
		tfttmn.setColumns(10);
		
		JButton btnDoanhThu = new JButton("Doanh thu");
		btnDoanhThu.setForeground(new Color(249, 224, 187));
		btnDoanhThu.setFont(new Font("Tahoma", Font.PLAIN, 25));
		btnDoanhThu.setBackground(new Color(17, 57, 70));
		btnDoanhThu.setBounds(273, 567, 186, 38);
		contentPane.add(btnDoanhThu);
		
		
		tfDoanhthu = new JTextField();
		tfDoanhthu.setFont(new Font("Tahoma", Font.PLAIN, 18));
		tfDoanhthu.setBounds(443, 567, 280, 38);
		contentPane.add(tfDoanhthu);
		tfDoanhthu.setColumns(10);
		
		JComboBox cbtkhdtnt = new JComboBox();
		cbtkhdtnt.setForeground(new Color(249, 224, 187));
		cbtkhdtnt.setBackground(new Color(17, 57, 70));
		cbtkhdtnt.setFont(new Font("Tahoma", Font.PLAIN, 18));
		cbtkhdtnt.setModel(new DefaultComboBoxModel(new String[] {"Thống kê hóa đơn", "Ngày ", "Tháng"}));
		cbtkhdtnt.setBounds(273, 496, 173, 38);
		contentPane.add(cbtkhdtnt);
		
		
		tftkhdtnt = new JTextField();
		tftkhdtnt.setFont(new Font("Tahoma", Font.PLAIN, 18));
		tftkhdtnt.setBounds(443, 496, 153, 38);
		contentPane.add(tftkhdtnt);
		tftkhdtnt.setColumns(10);
		...
		btnThngK.setBounds(591, 495, 129, 41);
		contentPane.add(btnThngK);
		JButton btnLmMi_1 = new JButton("Làm mới");
		btnLmMi_1.setForeground(new Color(249, 224, 187));
		btnLmMi_1.setFont(new Font("Tahoma", Font.PLAIN, 25));
		btnLmMi_1.setBackground(new Color(17, 57, 70));
		btnLmMi_1.setBounds(781, 567, 280, 39);
		contentPane.add(btnLmMi_1);
