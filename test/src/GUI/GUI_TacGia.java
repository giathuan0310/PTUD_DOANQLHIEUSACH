...
public class GUI_TacGia extends JFrame {
	...
	public GUI_TacGia() {
		...
		lbltenTG.setBounds(98, 181, 151, 44);
	...
	String[] headers= "Tên tác giả;Mã tác giả".split(";");
