...
public class GUI_NhanVien extends JFrame {
	 ...
	 */
	public GUI_NhanVien() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(GUI_NhanVien.class.getResource("/imgs/nv_tong_img.png")));
		...
		lblNewLabel_2.setBounds(90, 141, 151, 44);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_2_1 = new JLabel("Họ tên nhân viên:");
		lblNewLabel_2_1.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel_2_1.setForeground(new Color(234, 198, 150));
		lblNewLabel_2_1.setBounds(90, 188, 165, 44);
		contentPane.add(lblNewLabel_2_1);
		
		JLabel lblNewLabel_2_2 = new JLabel("SĐT:");
		lblNewLabel_2_2.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel_2_2.setForeground(new Color(234, 198, 150));
		lblNewLabel_2_2.setBounds(666, 147, 73, 32);
		contentPane.add(lblNewLabel_2_2);
		
		JLabel lblNewLabel_2_3 = new JLabel("ĐỊa chỉ:");
		lblNewLabel_2_3.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel_2_3.setForeground(new Color(234, 198, 150));
		lblNewLabel_2_3.setBounds(657, 201, 95, 38);
		contentPane.add(lblNewLabel_2_3);
		
		textField = new JTextField();
		textField.setFont(new Font("Tahoma", Font.PLAIN, 18));
		textField.setBounds(248, 146, 239, 32);
		contentPane.add(textField);
		textField.setColumns(10);
		
		JLabel lblNewLabel_3 = new JLabel("Tình trạng:");
		lblNewLabel_3.setForeground(new Color(234, 198, 150));
		lblNewLabel_3.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel_3.setBounds(90, 349, 105, 32);
		contentPane.add(lblNewLabel_3);
		

		ButtonGroup buttonGroup = new ButtonGroup(); 
        JRadioButton rdbtnNewRadioButton = new JRadioButton("Đang hoạt động");
        rdbtnNewRadioButton.setToolTipText("11");
        rdbtnNewRadioButton.setOpaque(false);
        rdbtnNewRadioButton.setForeground(new Color(234, 198, 150));
        rdbtnNewRadioButton.setFont(new Font("Tahoma", Font.PLAIN, 18));
        rdbtnNewRadioButton.setBounds(227, 349, 165, 32);
        contentPane.add(rdbtnNewRadioButton);
        buttonGroup.add(rdbtnNewRadioButton); 

        JRadioButton rdbtnNewRadioButton_1 = new JRadioButton("Ngưng hoạt động");
        rdbtnNewRadioButton_1.setOpaque(false);
        rdbtnNewRadioButton_1.setForeground(new Color(234, 198, 150));
        rdbtnNewRadioButton_1.setFont(new Font("Tahoma", Font.PLAIN, 18));
        rdbtnNewRadioButton_1.setBounds(408, 350, 187, 31);
		...
		scrollPane.setBounds(0, 444, 1143, 97);
		String[] headers = "Mã NV; Tên NV; Ngày sinh; Địa Chỉ; Tinh Trạng; SĐT; Chức vụ; Giới tính; CCCD".split(";");
		...
		JButton btnNewButton_1 = new JButton("Xem thông tin nhân viên bị xóa");
		btnNewButton_1.setBackground(new Color(17, 57, 70));
		btnNewButton_1.setForeground(new Color(234, 198, 150));
		btnNewButton_1.setFont(new Font("Tahoma", Font.PLAIN, 18));
		btnNewButton_1.setBounds(27, 567, 314, 44);
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Tìm nhân viên", "Mã ", "Tên"}));
		comboBox.setBounds(677, 569, 159, 42);
		contentPane.add(comboBox);
		
		
		textField_4 = new JTextField();
		textField_4.setFont(new Font("Tahoma", Font.PLAIN, 18));
		textField_4.setBounds(836, 569, 142, 42);
		contentPane.add(textField_4);
		textField_4.setColumns(10);
		
		JButton btnNewButton_2 = new JButton("");
		btnNewButton_2.setIcon(new ImageIcon(GUI_NhaCungCap.class.getResource("/imgs/search_img.png")));
		btnNewButton_2.setBackground(new Color(17, 57, 70));
		btnNewButton_2.setBounds(978, 569, 45, 42);
		...
		textField_1.setBounds(248, 195, 239, 32);
		contentPane.add(textField_1);
		
		textField_5 = new JTextField();
		textField_5.setFont(new Font("Tahoma", Font.PLAIN, 18));
		textField_5.setColumns(10);
		textField_5.setBounds(248, 242, 239, 32);
		contentPane.add(textField_5);
		
		textField_6 = new JTextField();
		textField_6.setFont(new Font("Tahoma", Font.PLAIN, 18));
		textField_6.setColumns(10);
		textField_6.setBounds(248, 293, 239, 32);
		contentPane.add(textField_6);
		
		textField_2 = new JTextField();
		textField_2.setFont(new Font("Tahoma", Font.PLAIN, 18));
		textField_2.setColumns(10);
		textField_2.setBounds(749, 147, 239, 32);
		contentPane.add(textField_2);
		
		textField_3 = new JTextField();
		textField_3.setFont(new Font("Tahoma", Font.PLAIN, 18));
		textField_3.setColumns(10);
		textField_3.setBounds(749, 204, 239, 32);
		contentPane.add(textField_3);
		
		textField_8 = new JTextField();
		textField_8.setFont(new Font("Tahoma", Font.PLAIN, 18));
		textField_8.setColumns(10);
		textField_8.setBounds(749, 315, 239, 32);
		contentPane.add(textField_8);
		
		JLabel lblNewLabel_2_3_1 = new JLabel("Giới tính:");
		lblNewLabel_2_3_1.setForeground(new Color(234, 198, 150));
		lblNewLabel_2_3_1.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel_2_3_1.setBounds(657, 255, 95, 38);
		contentPane.add(lblNewLabel_2_3_1);
		
		ButtonGroup buttonGroup_2 = new ButtonGroup(); 
		JRadioButton rdbtnNewRadioButton_2 = new JRadioButton("Nam");
		rdbtnNewRadioButton_2.setToolTipText("11");
		rdbtnNewRadioButton_2.setFont(new Font("Tahoma", Font.PLAIN, 18));
		rdbtnNewRadioButton_2.setForeground(new Color(249, 224, 187));
		rdbtnNewRadioButton_2.setOpaque(false);
		rdbtnNewRadioButton_2.setBounds(769, 258, 87, 32);
		contentPane.add(rdbtnNewRadioButton_2);
		buttonGroup_2.add(rdbtnNewRadioButton_2); 
		
		JRadioButton rdbtnNewRadioButton_2_1 = new JRadioButton("Nữ");
		rdbtnNewRadioButton_2_1.setForeground(new Color(249, 224, 187));
		rdbtnNewRadioButton_2_1.setFont(new Font("Tahoma", Font.PLAIN, 18));
		rdbtnNewRadioButton_2_1.setOpaque(false);
		rdbtnNewRadioButton_2_1.setBounds(857, 258, 87, 32);
		...
		lblNewLabel_2_1_1.setForeground(new Color(234, 198, 150));
		lblNewLabel_2_1_1.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel_2_1_1.setBounds(90, 242, 165, 44);
		contentPane.add(lblNewLabel_2_1_1);
		
		JLabel lblNewLabel_2_1_1_1 = new JLabel("ĐỊa chỉ:");
		lblNewLabel_2_1_1_1.setForeground(new Color(234, 198, 150));
		lblNewLabel_2_1_1_1.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel_2_1_1_1.setBounds(90, 291, 165, 44);
		contentPane.add(lblNewLabel_2_1_1_1);
		
		JLabel lblNewLabel_2_3_1_1 = new JLabel("CCCD:");
		lblNewLabel_2_3_1_1.setForeground(new Color(234, 198, 150));
		lblNewLabel_2_3_1_1.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel_2_3_1_1.setBounds(657, 312, 95, 38);
		contentPane.add(lblNewLabel_2_3_1_1);
		
		JButton btnNewButton_3 = new JButton("Thêm");
		btnNewButton_3.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnNewButton_3.setForeground(new Color(249, 224, 187));
		btnNewButton_3.setBackground(new Color(17, 57, 70));
		btnNewButton_3.setBounds(322, 394, 132, 39);
		contentPane.add(btnNewButton_3);
		
		JButton btnNewButton_3_1 = new JButton("Sửa");
		btnNewButton_3_1.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnNewButton_3_1.setForeground(new Color(249, 224, 187));
		btnNewButton_3_1.setBackground(new Color(17, 57, 70));
		btnNewButton_3_1.setBounds(525, 394, 132, 39);
		contentPane.add(btnNewButton_3_1);
		
		JButton btnNewButton_3_2 = new JButton("Xóa");
		btnNewButton_3_2.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnNewButton_3_2.setForeground(new Color(249, 224, 187));
		btnNewButton_3_2.setBackground(new Color(17, 57, 70));
		btnNewButton_3_2.setBounds(724, 394, 132, 39);
		...
		lblNewLabel_4.setBounds(0, 0, 1136, 643);
