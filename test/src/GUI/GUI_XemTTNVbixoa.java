...
public class GUI_XemTTNVbixoa extends JFrame {
	...
	public GUI_XemTTNVbixoa() {
		...
		btnDangXuat.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        if (JOptionPane.showConfirmDialog(null, "Bạn có muốn đăng xuất!", null, JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
		            GUI_TrangChu lg = new GUI_TrangChu();
		            lg.setVisible(true);
		            dispose();
		        }
		    }
		...
		Timer timer = new Timer(1000, new ActionListener() {
			...
			String[] headers = "Mã NV; Tên NV; Ngày sinh; Địa Chỉ; Tinh Trạng; SĐT; Chức vụ; Giới tính; CCCD; Lí do".split(";");
		...
		JButton btnKhiPhc = new JButton("Khôi phục");
